    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#all-classes" class="nav-link active" data-toggle="tab">Kelola Kelas</a></li>
                <li class="nav-item"><a href="#new-class" class="nav-link" data-toggle="tab"><i class="icon-plus2"></i> Buat
                        Kelas Baru</a></li>
            </ul>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="alert alert-info border-0 alert-dismissible">
                                ...
                                <span>Ketika sebuah kelas dibuat, sebuah Bagian akan secara otomatis dibuat untuk kelas
                                    tersebut, Anda dapat mengeditnya atau menambahkan lebih banyak bagian ke kelas di <a
                                        target="_blank" href="{{ route('sections.index') }}">Kelola Bagian</a></span>
                            </div>
                        </div>
                    </div>
                            ...
                            <form class="ajax-store" method="post" action="{{ route('classes.store') }}">
                                ...
                                <div class="form-group row">
                                    <label for="class_type_id" class="col-lg-3 col-form-label font-weight-semibold">Tipe
                                        Kelas</label>
                                    <div class="col-lg-9">
                                        <select required data-placeholder="Pilih Tipe Kelas" class="form-control select"
