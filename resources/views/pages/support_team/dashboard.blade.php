...
@section('content')
                ...
                <div class="card card-body bg-success-400 has-bg-image">
                    <div class="media">
                        ...
                        <div class="media-body text-right">
                            ...
                            <span class="text-uppercase font-size-xs">Total Administrator</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    {{-- Kalender Acara Dimulai --}}
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">Kalender Acara Sekolah</h5>
            {!! Qs::getPanelOptions() !!}
        </div>
