                ...
                <div class="col-md-6">
                    <form method="post" action="{{ route('exams.update', $ex->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <select data-placeholder="Pilih Guru" class="form-control select-search" name="term"
                                    id="term">
                                    <option {{ $ex->term == 1 ? 'selected' : '' }} value="1">Semester Pertama</option>
                                    <option {{ $ex->term == 2 ? 'selected' : '' }} value="2">Semester Kedua</option>
                                    <option {{ $ex->term == 3 ? 'selected' : '' }} value="3">Semester Ketiga</option>
                                </select>
                            </div>
                        </div>
