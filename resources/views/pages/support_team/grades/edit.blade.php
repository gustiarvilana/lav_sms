                ...
                <div class="col-md-6">
                    <form method="post" action="{{ route('grades.update', $gr->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input name="name" value="{{ $gr->name }}" required type="text"
                                    class="form-control" placeholder="Contoh: C4">
                            </div>
                        </div>
                            ...
                            <div class="col-lg-9">
                                <select class="form-control select" name="class_type_id" id="class_type_id">
                                    ...
                                    @foreach ($class_types as $ct)
                                        <option {{ $gr->class_type_id == $ct->id ? 'selected' : '' }}
                            ...
                            <div class="col-lg-9">
                                <select class="form-control select" name="remark" id="remark">
                                    ...
                                    @foreach (Mk::getRemarks() as $rem)
                                        <option {{ $gr->remark == $rem ? 'selected' : '' }} value="{{ $rem }}">
                                            {{ $rem }}</option>
                                    @endforeach
                                </select>
                            </div>
