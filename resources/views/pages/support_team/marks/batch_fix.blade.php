...
@section('page_title', 'Perbaiki Kesalahan Nilai')
@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title"><i class="icon-wrench mr-2"></i> Perbaikan Massal </h5>
            {!! Qs::getPanelOptions() !!}
        </div>
                ...
                <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select required id="section_id" name="section_id"
                                            data-placeholder="Pilih Kelas Dahulu" class="form-control select">
                                            @if ($selected)
                    ...
                    <div class="col-md-2 mt-4">
                        <div class="text-right mt-1">
                            <button type="submit" class="btn btn-danger">Perbaiki Kesalahan <i
