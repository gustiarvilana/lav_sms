        ...
        <tbody>
            @foreach ($marks->sortBy('user.name') as $mk)
                <tr>
                    ...
                    {{--             TUGAS DAN UJIAN --}}
                    <td><input title="Tugas 1" min="1" max="20" class="text-center"
                            name="t1_{{ $mk->id }}" value="{{ $mk->t1 }}" type="number"></td>
                    <td><input title="Tugas 2" min="1" max="20" class="text-center"
                            name="t2_{{ $mk->id }}" value="{{ $mk->t2 }}" type="number"></td>
                    <td><input title="Ujian" min="1" max="60" class="text-center"
