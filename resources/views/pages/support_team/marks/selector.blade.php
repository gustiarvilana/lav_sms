    ...
    <div class="row">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select required id="exam_id" name="exam_id" data-placeholder="Pilih Ujian"
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select required onchange="getClassSubjects(this.value)" id="my_class_id" name="my_class_id"
                                class="form-control select">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select required id="subject_id" name="subject_id" data-placeholder="Pilih Kelas Dahulu"
                                class="form-control select-search">
                                @if ($selected)
                                    @foreach ($subjects->where('my_class_id', $my_class_id) as $s)
                                        <option {{ $subject_id == $s->id ? 'selected' : '' }}
                                            value="{{ $s->id }}">{{ $s->name }}</option>
                                    @endforeach
                                @endif
                            </select>
        ...
        <div class="col-md-2 mt-4">
            <div class="text-right mt-1">
                <button type="submit" class="btn btn-primary">Kelola Nilai <i
