...
<head>
    <title>Lembar Tabulasi - {{ $my_class->name . ' ' . $section->name . ' - ' . $ex->name . ' (' . $year . ')' }}</title>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td>
                        ...
                        <strong><span style="color: #000; font-size: 15px;"> LEMBAR TABULASI UNTUK
                                {{ strtoupper($my_class->name . ' ' . $section->name . ' - ' . $ex->name . ' (' . $year . ')') }}
                            </span></strong>
                    </td>
                </tr>
            </table>
