...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="form-group">
                                    <label for="year" class="col-form-label font-weight-bold">Pilih Tahun <span
                                            class="text-danger">*</span></label>
                                    <select data-placeholder="Pilih Tahun" required id="year" name="year"
    ...
    @if ($selected)
        <div class="card">
            <div class="card-header header-elements-inline">
                <h6 class="card-title">Kelola Pembayaran untuk Sesi {{ $year }}</h6>
                {!! Qs::getPanelOptions() !!}
            </div>

            <div class="card-body">
                <ul class="nav nav-tabs nav-tabs-highlight">
                    <li class="nav-item"><a href="#all-payments" class="nav-link active" data-toggle="tab">Semua Kelas</a>
                    </li>
