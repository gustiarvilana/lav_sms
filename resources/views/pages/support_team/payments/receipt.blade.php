...
<head>
    <title>Kwitansi_{{ $pr->ref_no . '_' . $sr->user->name }}</title>
        ...
        <div id="print" xmlns:margin-top="http://www.w3.org/1999/xhtml">
            ...
            <div class="bold arial"
                ...
                <div style="padding: 10px 20px; width: 200px; background-color: lightcyan;">
                    <span  style="font-size: 16px;">Nomor Referensi Kwitansi</span>
                </div>
            ...
            <div style="margin-top:5px; display: block; background-color: rgba(92, 172, 237, 0.12); padding: 5px; ">
                <span style="font-weight:bold; font-size: 20px; color: #000; padding-left: 10px">INFORMASI SISWA</span>
            </div>
            ...
            {{-- Info Pembayaran --}}
            <div style="margin-top:5px; display: block; background-color: rgba(92, 172, 237, 0.12); padding: 5px; ">
                <span style="font-weight:bold; font-size: 20px; color: #000; padding-left: 10px">INFORMASI
                    PEMBAYARAN</span>
            </div>
            ...
            <table class="td-left" style="font-size: 16px" width="100%" cellspacing="2" cellpadding="2">
                <thead>
                    <tr>
                        ...
                        <td class="bold">Jumlah Dibayar <del style="text-decoration-style: double">N</del></td>
                        <td class="bold">Sisa <del style="text-decoration-style: double">N</del></td>
                    </tr>
                </thead>
                <tbody>
            ...
            <div class="bold arial"
                style="text-align: center; float:right; width: 200px; padding: 5px; margin-right:30px">
                <div style="padding: 10px 20px; width: 200px; background-color: lightcyan;">
                    <span  style="font-size: 16px;">{{ $pr->paid ? 'STATUS PEMBAYARAN' : 'TOTAL TUNGGAKAN' }}</span>
                </div>
                <div  style="padding: 10px 20px; width: 200px; background-color: lightyellow;">
