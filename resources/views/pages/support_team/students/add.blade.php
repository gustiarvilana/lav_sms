...
@section('page_title', 'Terima Siswa')
@section('content')
    <div class="card">
        <div class="card-header bg-white header-elements-inline">
            <h6 class="card-title">Silakan isi Formulir di Bawah ini untuk Menerima Siswa Baru</h6>
        ...
        <form id="ajax-reg" method="post" enctype="multipart/form-data" class="wizard-form steps-validation"
            ...
            <fieldset>
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="section_id">Bagian: <span class="text-danger">*</span></label>
                            <select data-placeholder="Pilih Kelas Dahulu" required name="section_id" id="section_id"
                                class="select-search form-control">
                                <option {{ old('section_id') ? 'selected' : '' }} value="{{ old('section_id') }}">
                                    {{ old('section_id') ? 'Terpilih' : '' }}</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Rumah Olahraga:</label>
                            <input type="text" name="house" placeholder="Rumah Olahraga" class="form-control"
                                value="{{ old('house') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="adm_no" placeholder="Nomor Induk" class="form-control"
                                value="{{ old('adm_no') }}">
                        </div>
                    </div>
                </div>
