...
@section('content')
    ...
    <div class="card">
        <div class="card-header bg-white header-elements-inline">
            <h6 id="ajax-title" class="card-title">Silakan isi Formulir di Bawah ini untuk Mengedit data dari
                {{ $sr->user->name }}</h6>
        ...
        <form method="post" enctype="multipart/form-data" class="wizard-form steps-validation ajax-update"
            ...
            <fieldset>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="select form-control" id="gender" name="gender" required data-fouc
                                ...
                                <option value=""></option>
                                <option {{ $sr->user->gender == 'Male' ? 'selected' : '' }} value="Male">Laki-laki
                                </option>
                                <option {{ $sr->user->gender == 'Female' ? 'selected' : '' }} value="Female">Perempuan
                                </option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select data-placeholder="Pilih..." required name="nal_id" id="nal_id"
                                ...
                                @foreach ($nationals as $na)
                                    <option {{ $sr->user->nal_id == $na->id ? 'selected' : '' }}
                    ...
                    <div class="col-md-3">
                        ...
                        <select onchange="getLGA(this.value)" required data-placeholder="Pilih.."
                            ...
                            @foreach ($states as $st)
                                <option {{ $sr->user->state_id == $st->id ? 'selected' : '' }}
                    ...
                    <div class="col-md-3">
                        <label for="lga_id">Kota/Kabupaten: <span class="text-danger">*</span></label>
                        <select required data-placeholder="Pilih Provinsi Dahulu" class="select-search form-control"
                        ...
                        <div class="form-group">
                            ...
                            <select class="select form-control" id="bg_id" name="bg_id" data-fouc
                                ...
                                @foreach (App\Models\BloodGroup::all() as $bg)
                                    <option {{ $sr->user->bg_id == $bg->id ? 'selected' : '' }}
            ...
            <fieldset>
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select onchange="getClassSections(this.value)" name="my_class_id" required id="my_class_id"
                                class="form-control select-search" data-placeholder="Pilih Kelas">
                                <option value=""></option>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select data-placeholder="Pilih..." name="my_parent_id" id="my_parent_id"
                                class="select-search form-control">
                                <option value=""></option>
                                @foreach ($parents as $p)
                                    <option {{ Qs::hash($sr->parent_id) == Qs::hash($p->id) ? 'selected' : '' }}
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="year_admitted" data-placeholder="Pilih..." id="year_admitted"
                                class="select-search form-control">
                                <option value=""></option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Nomor Kamar Asrama:</label>
                            <input type="text" name="dorm_room_no" placeholder="Nomor Kamar Asrama"
                                class="form-control" value="{{ $sr->dorm_room_no }}">
                        </div>
                    </div>
                </div>
            </fieldset>
