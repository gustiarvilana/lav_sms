...
@section('page_title', 'Siswa Lulusan')
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Siswa Lulusan</h6>
            {!! Qs::getPanelOptions() !!}
        </div>

        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#all-students" class="nav-link active" data-toggle="tab">Semua Siswa Lulusan</a>
                </li>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-left">
                                                    ...
                                                    @if (Qs::userIsTeamSA())
                                                        ...
                                                        <a id="{{ Qs::hash($s->id) }}" href="#"
                                                            ...
                                                            class="dropdown-item"><i class="icon-stairs-down"></i> Belum
                                                            Lulus</a>
                                            ...
                                            <div class="list-icons">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-left">
                                                        ...
                                                        <a target="_blank"
                                                            href="{{ route('marks.year_selector', Qs::hash($s->user->id)) }}"
                                                            class="dropdown-item"><i class="icon-check"></i> Daftar
                                                            Nilai</a>
