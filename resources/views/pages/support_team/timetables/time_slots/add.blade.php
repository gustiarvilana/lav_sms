<div class="row">
    <div class="col-md-12">
        <div class="alert alert-info text-center">
            <span>Anda dapat Menambahkan Slot Waktu Baru atau Memilih Menggunakan Slot Waktu yang Sudah Ada dari Jadwal
                Lain.
                <strong>Catatan:</strong> Menggunakan Slot Waktu yang Sudah Ada akan Mengatur Ulang Jadwal Saat
                Ini</span>
        </div>
    </div>
            ...
            <div class="card-body collapse">
                <div class="col-md-12">
                    <form method="post" action="{{ route('ts.use', $ttr->id) }}">
                        ...
                        <div class="text-right">
                            <button type="submit" class="btn btn-lg btn-success">Kirim <i
                                    class="icon-paperplane ml-2"></i></button>
                        </div>
                    </form>
                </div>
