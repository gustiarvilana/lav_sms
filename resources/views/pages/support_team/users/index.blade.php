    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#new-user" class="nav-link active" data-toggle="tab">Buat Pengguna Baru</a></li>
                <li class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Kelola Pengguna</a>
                        ...
                        <fieldset>
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select required data-placeholder="Pilih Pengguna" class="form-control select"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('address') }}" class="form-control" placeholder="Alamat"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('email') }}" type="email" name="email"
                                            class="form-control" placeholder="anda@email.com">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('phone') }}" type="text" name="phone"
                                            class="form-control" placeholder="+621234567">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="select form-control" id="gender" name="gender" required
                                            data-fouc data-placeholder="Pilih..">
                                            <option value=""></option>
                                            <option {{ old('gender') == 'Pria' ? 'selected' : '' }} value="Pria">Pria
                                            </option>
                                            <option {{ old('gender') == 'Wanita' ? 'selected' : '' }} value="Wanita">
                                                Wanita</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select required data-placeholder="Pilih Provinsi Terlebih Dahulu"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <span class="form-text text-muted">Gambar yang diterima: jpeg, png. Ukuran file
                                            maksimal 2Mb</span>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-left">
                                                        ...
                                                        <a href="{{ route('users.show', Qs::hash($u->id)) }}"
                                                            class="dropdown-item"><i class="icon-eye"></i> Lihat
                                                            Profil</a>
                                                        {{-- Edit --}}
                                                        ...
                                                        @if (Qs::userIsSuperAdmin())
                                                            <a href="{{ route('users.reset_pass', Qs::hash($u->id)) }}"
                                                                class="dropdown-item"><i class="icon-lock"></i> Atur Ulang
                                                                Kata Sandi</a>
                                                            {{-- Delete --}}
                                                            <a id="{{ Qs::hash($u->id) }}"
