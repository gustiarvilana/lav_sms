...
@section('content')
    <div class="row">
        <div class="col-md-3 text-center">
            <div class="card">
                <div class="card-body">
                    <img style="width: 90%; height:90%" src="{{ $user->photo }}" alt="foto" class="rounded-circle">
                    <br>
                        ...
                        <div class="tab-pane fade show active" id="basic-info">
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    @if ($user->username)
                                        <tr>
                                            <td class="font-weight-bold">Nama Pengguna</td>
                                            <td>{{ $user->username }}</td>
                                        </tr>
                                    @endif
                                    @if ($user->phone)
                                    ...
                                    @if ($user->user_type == 'parent')
                                        <tr>
                                            <td class="font-weight-bold">Anak/Wali</td>
                                            <td>
                                    ...
                                    @if ($user->user_type == 'teacher')
                                        <tr>
                                            <td class="font-weight-bold">Mata Pelajaran Saya</td>
                                            <td>
